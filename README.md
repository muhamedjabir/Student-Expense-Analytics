...
The objective was to transform daily expense data into meaningful
insights using SQL for data analysis and Power BI for visualization.

This is an end-to-end data analytics case study covering: - Data
...
-   Daily spending remains relatively stable with occasional high-value
    spikes.
...
-   Total Spending KPI
-   Average Daily Spending KPI
-   Highest Expense Day KPI
...
-   Monthly Category Breakdown Matrix
...
-   Highest expense day identification
